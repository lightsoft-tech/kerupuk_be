...
<div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
                <img src="{{ asset('/upload/home/'. $jumbotron->image_description) }}" alt="your image" width="60" height="60"/>
...
<div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        <h5 class="color-theme-primary">
            ...
            <div class="col-md-3">
                        <img src="{{ asset('/upload/home/'. $produkHome->image_produk) }}" alt="your image" width="60" height="60"/>
...
<div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        <h5 class="color-theme-primary">
            ...
            <div class="col-md-3">
                        <img src="{{ asset('/upload/home/'. $suggestionHome->image_suggestion) }}" alt="your image" width="60" height="60"/>
