        ...
        @foreach ($jumbotrons as $jumbotron)
            <div class="col-md-3">
                <img class="" src="{{ asset('/upload/home/'. $jumbotron->image_description) }}" alt="your image" height="150"/>
                    <button class="remove-image delete-jumbotron" data-id="{{ $jumbotron->id }}">
                        REMOVE
                    </button>
            </div>
            @endforeach
    ...
    <div class="row pt-5">
        <h5 class="color-theme-primary">
            ...
            <div class="col-md-3">
                        ...
                        <button class="remove-image delete-produk" data-id="{{ $produkHome->id }}">
                            REMOVE
                        </button>
                </div>
                @endforeach
        ...
        <h5 class="color-theme-primary">
            ...
            <div class="col-md-3">
                        <img class="" src="{{ asset('/upload/home/'. $suggestionHome->image_suggestion) }}" alt="your image" height="150"/>
                            <button class="remove-image delete-suggestion" data-id="{{ $suggestionHome->id }}">
                                REMOVE
                            </button>
                </div>
                @endforeach
...
@endif
{{-- alert delete data jumbotron --}}
<script>
    $('.delete-jumbotron').click(function(){
        ...
        .then((willDelete) => {
        if (willDelete) {
            window.location = "/admin/home-jumbotron-delete/"+id+""
        } else {
...
<script>
    $('.delete-produk').click(function(){
        ...
        .then((willDelete) => {
        if (willDelete) {
            window.location = "/admin/home-produk-delete/"+id+""
        } else {
            swal("Data tidak jadi dihapus");
        }
        });
...
<script>
    $('.delete-suggestion').click(function(){
        ...
        .then((willDelete) => {
        if (willDelete) {
            window.location = "/admin/home-suggestion-delete/"+id+""
        } else {
            swal("Data tidak jadi dihapus");
        }
        });
