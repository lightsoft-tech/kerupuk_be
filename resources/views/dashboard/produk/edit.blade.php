        ...
        <div class="card-body">
          <form action="/admin/produk-update/{{ $produk->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="wrap-input100 validate-input">
              ...
              <input class="input100" type="text" name="name_produk" value="{{ $produk->name_produk }}"  placeholder="Nama Produk" id="harga">
            </div>
            ...
            <div class="wrap-input100 validate-input mt-3">
              ...
              <input class="input100" type="number" name="price" value="{{ $produk->price }}"   placeholder="Harga Produk" id="harga">
            </div>
            ...
            <div class="wrap-input100 validate-input mt-3">
              ...
              <input class="input100" type="text" name="description" value="{{ $produk->description }}"   placeholder="Deskripsi Produk" id="deskripsi">
            </div>
            ...
            <div class="wrap-input100 validate-input mt-3">
              ...
              <input class="input100" type="number" name="stock" value="{{ $produk->stock }}"   placeholder="Stok Produk" id="stok">
            </div>
            ...
            <div class="file-upload">
              <div class="image-upload-wrap">
                <input class="file-upload-input" type='file' onchange="readURL(this);" accept="image/*" name="image" value="{{ $produk->image }}" />
                <div class="drag-text">
              ...
              <div class="file-upload-content">
                <img class="file-upload-image" src="{{ asset('upload/produks/'.$produk->image) }}" alt="your image" />
