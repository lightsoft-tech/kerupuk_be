...
<div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div class="mt-2">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card-body">
          <form method="POST" action="/admin/expenditures-store">
            @csrf
            ...
            <div class="wrap-input100 validate-input">
              ...
              <input class="input100" type="text" name="description" placeholder="Keterangan" id="keterangan">
            </div>
            ...
            <div class="wrap-input100 validate-input mt-3">
              ...
              <input class="input100" type="number" name="cost"  placeholder="Biaya" id="biaya">
            </div>
            {{-- button triger --}}
